...
class SalesOrder(Base):
    ...
    def to_dict(self):
        return {
            ...
            "order_type": self.order_type or 'REGULAR',
            "blanket_valid_from": self.blanket_valid_from.isoformat() if self.blanket_valid_from else None,
            "blanket_valid_until": self.blanket_valid_until.isoformat() if self.blanket_valid_until else None,
            "qty_reserved": self.qty_reserved or 0,
...
class SOLine(Base):
    ...
    def to_dict(self):
        return {
            ...
            "qty_released": self.qty_released or 0,
