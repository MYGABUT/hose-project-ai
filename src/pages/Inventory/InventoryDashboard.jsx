/**
 * Inventory Dashboard - Excel-Style Super Dashboard
 * Multi-Gudang, JO Pending, FPP Status, Available
 */
            ...
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">
                        Kontrol stok multi-gudang dengan status JO & FPP
                    </p>
                </div>
            ...
            <Card className="filter-bar">
                <div className="filter-row">
                    ...
                    <div className="filter-summary">
                        Menampilkan <strong>{data.length}</strong> dari <strong>{total}</strong> item
                    </div>
                </div>
            </Card>
